...
class TestF1:
    ...
    def test_positive(self,
        ...
        self.driver.get("https://ee.dlg.im/")
        self.driver.implicitly_wait(5)
        enter_server_use_enter(self.driver, "https://dsk.eelab.transmit.im")
        enter_credentials_on_login_page_use_enter(self.driver, "test1", "123456")
        assert assert_element_exist_by_id(self.driver, "sidebar_header_menu")
        assert assert_element_exist_by_xpath(self.driver, "/html/body/div[1]/div/aside/div/header/div[1]/a/div[2]")
    ...
    def test_negative_incorrect_server(self,
                                       server_url,
                                       error_message,
                                       enter_server_use_enter,
                                       assert_element_exist_by_xpath,
        ...
        self.driver.get("https://ee.dlg.im/")
        self.driver.implicitly_wait(5)
        enter_server_use_enter(self.driver, server_url)
        try:
            enter_credentials_on_login_page_use_enter(self.driver, "test1", "123456")
        except NoSuchElementException:
            pytest.fail("Do not get login form")
        assert_element_exist_by_id(self.driver, "sidebar_header_menu")
    ...
    def test_negative_incorrect_login_password(self,
                      login,
                      error_message,
                      password,
                      assert_element_exist_by_xpath,
        ...
        self.driver.implicitly_wait(5)
        enter_server_use_enter(self.driver, "https://dsk.eelab.transmit.im")
        enter_credentials_on_login_page_use_enter(self.driver, login, password)
        assert assert_element_exist_by_xpath(self.driver,
